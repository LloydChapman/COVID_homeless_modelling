...
N_tested <- c(37 + 10,44 + 7) # numbers of residents and staff tested during mass testing
...
# Observed data
D_S <- NULL
D_T <- c(6 + 0,10 + 1) # number of positives in residents and staff during mass testing
