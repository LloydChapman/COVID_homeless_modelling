...
end_date <- as.Date("4/5/2020",format = "%m/%d/%Y")
...
testing_dates <- as.Date("4/1/2020",format="%m/%d/%Y") # testing dates
N_tested <- 43 + 15 # numbers of residents and staff tested during mass testing
...
# Observed data
D_S <- NULL
D_T <- 7 + 4 # number of positives in residents and staff during mass testing
